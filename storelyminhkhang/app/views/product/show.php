...
<div class="card shadow border-0 rounded-4 overflow-hidden mb-5">
    <div class="row g-0">
        <div class="col-md-5 text-center p-4 d-flex align-items-center justify-content-center" style="background-color: #fff;">
        ...
        <div class="col-md-7">
            <div class="card-body p-4 p-md-5 h-100 d-flex flex-column bg-light border-start">
                ...
                <div class="p-3 mb-4 rounded-3 shadow-sm" style="background-color: #fdf2f2; border: 1px solid #f9d3d3;">
                    <p class="mb-1 text-danger fw-bold small">Giá khuyến mãi đặc biệt:</p>
                    <h2 class="fw-bold mb-0" style="color: #d70018;">
